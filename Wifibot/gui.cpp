	...
	
{
	...
	Gtk::HBox* m_hbox_batterie = Gtk::manage(new Gtk::HBox(false, 5));
	...
	Gtk::Label* label_batterie = Gtk::manage(new Gtk::Label("Batterie :"));
	...
	m_hbox_batterie->pack_start(*label_batterie, Gtk::PACK_SHRINK);
	m_hbox_batterie->pack_start(m_entree_batterie, Gtk::PACK_SHRINK);
	m_vbox->add(*m_hbox_batterie);
